...
// Vladi go e vzel ot githuba na picha otgore, moje da se polzva tozi cookie.js ili cookies.js pisan ot Vladi
    ...
    cookie.set = function(key, value, options) {
        ...
        if (utils.isPlainObject(key)) { // Then `key` contains an object with keys and values for cookies, `value` contains the options object.
            ...
            var expires     = options.expires !== undefined ?
                              options.expires :
                              (this.defaults.expires || ''), // Empty string for session cookies.
            ...
            var secure = options.secure || this.defaults.secure ?
                         ';secure' :
                         '';
